...
public class ModFoodComponents {
    ...
    public static final FoodComponent BOWL_OF_RICE = new FoodComponent.Builder().hunger(4).saturationModifier(0.8f).build();
    public static final FoodComponent PASTA = new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).build();
    public static final FoodComponent KIMBAP = new FoodComponent.Builder().hunger(6).saturationModifier(0.8f).build();
}
